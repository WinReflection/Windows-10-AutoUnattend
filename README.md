...
2. Windows 11 ADK and Microsoft Deployment Toolkit (MDT) installed on a supported version of Windows 11.
...
7. Have USB drive inserted into computer during install of Windows so Setup.exe can find it.
...
## Files
- install_Windows 10 Pro.clg - Catalog file generated by Windows System Image Manager (WSIM) for Windows 10 Pro.
- Unattend_mdt-default-windows-10-pro-22h2-rtm.xml - Default answer file generated by MDT for Windows 10 Pro.
- AutoUnattend-mdt-defaults-windows-10-pro-22h2-rtm.xml - Answer file for USB installation, as close to Microsoft's defaults as possible.
...
#### Patches:
Please refer to Microsoft Deployment Toolkit Known Issues for help with issues, [here.](https://learn.microsoft.com/en-us/mem/configmgr/mdt/known-issues)
